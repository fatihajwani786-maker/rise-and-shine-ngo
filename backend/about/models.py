...
class AboutPageContent(models.Model):
    """
    A singleton model to store all the textual content for the About Us page.
    """
...
class TeamMember(models.Model):
    """
    A model to store each team member's information.
    """
    ...
    # This is where Pillow (the library you installed) is used!
